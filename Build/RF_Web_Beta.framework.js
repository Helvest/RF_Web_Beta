...
var ASM_CONSTS = {
  2687392: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2687447: function($0) {performance.now = function() { return $0; };},  
 2687495: function($0) {performance.now = function() { return $0; };},  
 2687543: function() {performance.now = Module['emscripten_get_now_backup'];},  
 2687598: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2687659: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2687723: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _captureFile(fileType, multiple) {
      fileType = UTF8ToString(fileType);
      multiple = UTF8ToString(multiple);
  
      console.log("captureFile(" + fileType + "," + multiple + ")");
  
      let fileInput = document.getElementById('FileUploaderInput');
        ...
        fileInput.onchange = function (event) {
          ...
          if (files.length > 0) {
            for (let i = 0; i < files.length; i++) {
              ...
              SendMessage('UserLoadFile', 'OnFileSelected', fileUrl);
            }
          }
        };
  ...
  function _location_scale_rez(scale)
      {
          ScaleRez(scale);
      }
  ...
  function _location_set_search(str)
      {
          window.history.replaceState(null, null, '?' + UTF8ToString(str));
      }

  function _location_test(value)
      {
          Test(value);
      }
...
var asmLibraryArg = {
  ...
  "location_isMobile": _location_isMobile,
